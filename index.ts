...
function simulateShopping(choice: string): void {
...
function simulateShoppings(choice: string, quantity: number): void {
    console.log("Welcome to the Grocery Store!");
...
async function simulateCheckout(totalBill: number): Promise<void> {
    ...
    while (selectedPaymentMethod === null) {
        ...
        const paymentQuestion: QuestionCollection = {
            type: 'list',
